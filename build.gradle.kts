...
val jacksonModuleVersion = "3.1.3"
...
val hibernateTypesVersion = "3.15.3"

val springCloudGcpVersion = "8.0.4"
...
plugins {
    ...
    val kotlinterPluginVersion = "5.5.0"
    val sonarQubePluginVersion = "7.3.0.8198"
