...
INSERT INTO public.tab (label, tab_order, user_id) VALUES ('News', 1, (select id from users where username ='admintest'));
INSERT INTO public.tab (label, tab_order, user_id) VALUES ('Weather', 1, (select id from users where username ='admintest'));
